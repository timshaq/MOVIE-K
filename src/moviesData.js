export const moviesData = [
  ...
  },
  {
    ...
    adult: false,
    overview:
      "The love affair between poet Percy Shelley and Mary Wollstonecraft Godwin resulted in the creation of an immortal novel, âFrankenstein; or, The Modern Prometheus.â",
  ...
  },
  {
    ...
    adult: false,
    overview:
      "When three parents discover their daughtersâ pact to lose their virginity at prom, they launch a covert one-night operation to stop the teens from sealing the deal.",
  ...
  },
  {
    ...
    original_title: "ÐÐµÐ»Ð¾ Ð¡Ð¾Ð±ÑÐ°ÐºÐ°",
    backdrop_path: "/pU5c029oAV7WQND202vYt0ldeUI.jpg",
    adult: false,
    overview:
      "After the fatherâs death, the daughter of one of the forefathers of modern Russian democracy, Ksenia Sobchak, tries to understand the 18 years of his political fate. Together with the director Vera Krichevskaya she gives the word to Anatoli Sobchakâs colleagues and opponents, gets acquainted with the criminal case which annulled his career, and tries to find an answer to the question what Anatoly Sobchakâs fate would be in todayâs Russia.",
